...
library BytesLib {
    ...
    */
    ...
    function flipString(string memory _str) external pure returns(string memory) {
    ...
    function toHexString(bytes20 _bytes) internal pure returns (string memory) {
        return toHexString(uint256(uint160(_bytes)), ADDRESS_LENGTH);
    }
}