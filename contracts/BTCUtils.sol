...
library BTCUtils {
    ...
    /// @return v        The reversed bytes
    function reverseEndianness(bytes memory _b) internal pure returns (bytes memory v) {
    ...
    /// @param _b        The pre-image
    /// @return v        The digest
    function hash256(bytes memory _b) internal pure returns (bytes32 v) {
